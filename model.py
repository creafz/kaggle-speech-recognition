"""
A slightly modified version of NASNet-A-Large
...
class CellStem0(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_1x1.add_module('bn',
                                 nn.BatchNorm2d(42, eps=0.001, momentum=0.1,
                                                affine=True))

        self.comb_iter_0_left = BranchSeparables(42, 42, 5, 2, 2)
        self.comb_iter_0_right = BranchSeparablesStem(96, 42, 7, 2, 3,
                                                      bias=False)

        self.comb_iter_1_left = nn.MaxPool2d(3, stride=2, padding=1)
        self.comb_iter_1_right = BranchSeparablesStem(96, 42, 7, 2, 3,
                                                      bias=False)

        self.comb_iter_2_left = nn.AvgPool2d(3, stride=2, padding=1,
                                             count_include_pad=False)
        self.comb_iter_2_right = BranchSeparablesStem(96, 42, 5, 2, 2,
                                                      bias=False)
...
class CellStem1(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv_1x1.add_module('bn',
                                 nn.BatchNorm2d(84, eps=0.001, momentum=0.1,
                                                affine=True))
...
class FirstCell(nn.Module):
    ...
    def forward(self, x, x_prev):
        ...
        x_out = torch.cat([x_left, x_comb_iter_0, x_comb_iter_1, x_comb_iter_2,
...
class NormalCell(nn.Module):
    ...
    def __init__(self, in_channels_left, out_channels_left, in_channels_right,
        ...
        self.conv_prev_1x1.add_module('conv', nn.Conv2d(in_channels_left,
                                                        out_channels_left, 1,
                                                        stride=1, bias=False))
        self.conv_prev_1x1.add_module('bn', nn.BatchNorm2d(out_channels_left,
                                                           eps=0.001,
                                                           momentum=0.1,
                                                           affine=True))
...
class ReductionCell1(nn.Module):
    ...
    def __init__(self, in_channels_left, out_channels_left, in_channels_right,
        ...
        self.comb_iter_0_left = BranchSeparables(out_channels_right,
                                                 out_channels_right, 5, 2, 2,
                                                 bias=False)
        self.comb_iter_0_right = BranchSeparables(out_channels_right,
                                                  out_channels_right, 7, 2, 3,
                                                  bias=False)
...
class NASNetALarge(nn.Module):
    ...
    def __init__(self, num_classes, dropout_p):
        ...
        self.conv0.add_module('conv', nn.Conv2d(in_channels=1, out_channels=96,
                                                kernel_size=3, padding=0,
                                                stride=2,
                                                bias=False))
        self.conv0.add_module('bn', nn.BatchNorm2d(96, eps=0.001, momentum=0.1,
                                                   affine=True))
...
def make_nasnet_model(num_classes, dropout_p):
    batch_norm = nn.BatchNorm2d(1)
    model = NASNetALarge(num_classes, dropout_p)
    return nn.DataParallel(nn.Sequential(batch_norm, model))
